...
{
    public abstract class azuretest6WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static azuretest6WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(azuretest6WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<azuretest6DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<azuretest6DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<azuretest6DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<azuretest6DbContext, Task<T>> func)
        {
            T result;
